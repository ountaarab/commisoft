<?php
error_reporting(0);
require_once 'core/denzoecode.php';
...
<html>
    <head>
        <title>AWD Arta Web Design</title>
...
<!-- 
                             <div class="form-group">
                                            <div class="checkbox  <?php // echo file_exists('../application/third_party/mpdf/src/mpdf.php') ? '' : 'disabled';   ?>">
                    ...
                    <?php // echo file_exists('../application/third_party/mpdf/src/mpdf.php') ? '' : 'disabled'; ?>>
                                                    Export PDF
                                                </label>
                    <?php // echo file_exists('../application/third_party/mpdf/src/mpdf.php') ? '' : '<small class="text-danger">mpdf required, download <a href="http://harviacode.com">here</a></small>'; ?>
                                            </div>
                            </div> -->
            ...
            <div class="col-md-9">
                <h3 style="margin-top: 0px">Codeigniter CRUD Generator 1.4 by <a target="_blank" href="http://awd.com">AWD Arta Web Design</a></h3>
                <p><strong>About :</strong></p>
                <p>
                   software ini dibuat untuk mempermudah membuat program CRUD.
                </p>
                
                <p><strong>&COPY; 2019 <a target="_blank" href="http://aasoftdevelover.com">AWD Arta Web Design</a></strong></p>
            </div>
        </div>
