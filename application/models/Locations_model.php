...
class Locations_model extends CI_Model
{
    ...
    $this->db->where(''.$this->table.'.location_status', $status);
    $this->db->where('tbl_projects.project_status', $status);
    $this->db->from($this->table);
    $this->db->join('tbl_projects', ''.$this->table.'.location_project_no = tbl_projects.id');
 ...
 // get total rows
    ...
    $this->db->or_like(''.$this->table.'.location_project_no', $q);
    $this->db->or_like('tbl_projects.project_name', $q);
    $this->db->or_like(''.$this->table.'.location_id', $q);
    $this->db->or_like(''.$this->table.'.location_name', $q);
    $this->db->group_end();
    $this->db->select(''.$this->table.'.*, tbl_projects.project_name,tbl_projects.project_status');
    $this->db->where(''.$this->table.'.location_status', $status);
    $this->db->where('tbl_projects.project_status', $status);
