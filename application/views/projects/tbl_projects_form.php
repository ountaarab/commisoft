...
<table class='table table-striped'>        
        ...
        <td><input type="text" class="form-control" name="project_id" id="project_id" placeholder="Project Id" value="<?php echo $project_id; ?>"  /></td>
      </tr>
	    <tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_projects" value="<?php echo $id_projects; ?>" /> 
	    <button type="submit" class="btn btn-danger" id="submit" ><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('projects') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Back</a></td></tr>
	</table></form> 
</div>
</div>
</section>
