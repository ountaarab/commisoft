...
<?php foreach ($systems_data as $systems) { ?>
    <tr>
        <td width="10px"><input type="checkbox" class="checkitem" name="pilih[]" value="<?=$systems->id_system?>"></td>
        ...
        <td>
            <?php 
            echo anchor(site_url('systems/read/'.$systems->id_system),'<i class="icon-desktop" aria-hidden="true"></i>'); 
            echo '  '; 
            echo anchor(site_url('systems/update/'.$systems->id_system),'<i class="icon-edit" aria-hidden="true"></i>'); 
            echo '  '; 
            echo anchor(site_url('systems/delete/'.$systems->id_system),'<i class="icon-trash" aria-hidden="true"></i>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
            ?>
        </td>
    </tr>
<?php } ?>
