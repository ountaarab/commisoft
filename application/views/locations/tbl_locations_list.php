...
<?php foreach ($locations_data as $locations) { ?>
    <tr>
    	<td width="10px"><input type="checkbox" class="checkitem" name="pilih[]" value="<?=$locations->id_location?>"></td>
    	...
    	<td>
    		<?php 
    		echo anchor(site_url('locations/read/'.$locations->id_location),'<i class="icon-desktop" aria-hidden="true"></i>'); 
    		echo '  '; 
    		echo anchor(site_url('locations/update/'.$locations->id_location),'<i class="icon-edit" aria-hidden="true"></i>'); 
    		echo '  '; 
    		echo anchor(site_url('locations/delete/'.$locations->id_location),'<i class="icon-trash" aria-hidden="true"></i>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
    		?>
    	</td>
    </tr>
<?php } ?>
