            ...
            <div class="span12">
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h4 class="box-title"><strong>KELOLA HAK AKSES UNTUK LEVEL :  <?php echo $level['nama_level'] ?></strong></h4>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <td>$no</td>
                        <td>$m->title</td>
                        <td align='center'><input class='form-control' type='checkbox' ".  checked_akses($this->uri->segment(3), $m->id_menu)." onClick='kasi_akses($m->id_menu)'></td>
                        </tr>";
                                        $no++;
                                    }
                                    ?>
