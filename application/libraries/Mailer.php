...
class Mailer {
    protected $_ci;
   // protected $email_pengirim = 'denzoe.da@gmail.com'; // Isikan dengan email pengirim
   ...
   // protected $password = '######'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        if($send){ // Jika Email berhasil dikirim
            $response = array('status'=>'Sukses', 'message'=>'Email berhasil dikirim ke '.$data['email_pengirim']);
        }else{ // Jika Email Gagal dikirim
            $response = array('status'=>'Gagal', 'message'=>'Email gagal dikirim ke '.$data['email_pengirim']);
        }
    ...
    public function send_with_attachment($data){
        ...
        $mail->Subject = $data['subjek'];
        $mail->Body = $data['content'];
        $mail->AddEmbeddedImage('assets/foto_profil/logo.png', 'logo_mynotescode', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
